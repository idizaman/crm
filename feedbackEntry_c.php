...
if(isset($_POST['btnSave']))
{
	...
	$fdbkIdresult=mysql_query($fdbkIdquery);
 	...
 	$query="INSERT INTO  feedbackdata (fdbkId,userId,contrNo,campId,fdbk1Id,fdbk2Id,flwupDate,remarks,entryDate,entryTime) values('$fdbkId','$userId','$contrNo','$campId','$fdbk1Id','$fdbk2Id','$flwupDate','$remarks',curdate(),curtime())";
